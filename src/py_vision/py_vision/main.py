...
def Identification():
    ...
    # Crear el objeto ORB
    orb = cv2.ORB_create(nfeatures=6900, scaleFactor=1.6, nlevels=9, edgeThreshold=10)
    ...
    cv2.imwrite("MatchesResultado.png", resultado)
    ...
    if conteo_matches_secciones[fila_max_matches, columna_max_matches] >= 5:
        ...
        print("No es parte del Puzzle, girar para seguir buscando la piezza...")

    cv2.destroyAllWindows()

    return columna_max_matches + 3*fila_max_matches