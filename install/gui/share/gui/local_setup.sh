...
: ${AMENT_CURRENT_PREFIX:="/home/miripablo/puzzle_ros/install/gui"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gui/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gui/environment/path.sh"
